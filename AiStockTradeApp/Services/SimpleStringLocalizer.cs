    ...
    public class SimpleStringLocalizer : IStringLocalizer<SharedResource>
    {
        ...
        private void LoadTranslations()
        {
            ...
            _translations["en"] = new Dictionary<string, string>
            {
                ...
                ["Empty_Watchlist"] = "Your watchlist is empty. Add a stock to get started.",
                ["Empty_Watchlist_Anon"] = "Your session watchlist is empty. Add a stock (no account required).",
                ["Privacy_Notice"] = "Anonymous session watchlists are stored only in memory and cleared when your session expires.",
                ["Partial_Errors"] = "Some data failed to load",
            ...
            _translations["fr"] = new Dictionary<string, string>
            {
                ...
                ["Empty_Watchlist"] = "Votre liste est vide. Ajoutez une action pour commencer.",
                ["Empty_Watchlist_Anon"] = "Votre liste de session est vide. Ajoutez une action (aucun compte requis).",
                ["Privacy_Notice"] = "Les listes de session anonymes sont stockées uniquement en mémoire et effacées à l'expiration.",
                ["Partial_Errors"] = "Certaines données n'ont pas pu être chargées",
                ["Lang_English"] = "English",
                ["Lang_French"] = "Français",
